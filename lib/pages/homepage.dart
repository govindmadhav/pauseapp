...
import 'package:tracker/pages/tabs.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void asyncInit() async {
    ...
    infos = await usageMethods.getDailyUsageStats();
    _response = await airtableApiServices.fetchAirtableData();
    _points = _response['records'][2]['fields']['rewardcoins'];
    await airtableApiServices.updateUsage(_usage.toInt());

    //TODO: add defaults for 0 time
    // int i = 1;
    // while (i < 15) {
    //   if (infos[i].appName.toString().toUpperCase() == "YOUTUBE") {
    //     _youtube = infos[i].usage.inMinutes.toInt();
    //     await airtableApiServices.updateYoutube(_youtube.toInt());
    //   }
    //   if (infos[i].appName.toString().toUpperCase() == "WHATSAPP") {
    //     _whatsapp = infos[i].usage.inMinutes.toInt();
    //     await airtableApiServices.updateWhatsapp(_whatsapp.toInt());
    //   }
    //   if (infos[i].appName.toString().toUpperCase() == "CHROME") {
    //     _chrome = infos[i].usage.inMinutes.toInt();
    //     await airtableApiServices.updateChrome(_chrome.toInt());
    //   }
    //   i++;
    // }
