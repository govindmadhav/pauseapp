...
class _ProfileState extends State<Profile> {
  ...
  void asyncInit() async {
    ...
    // _streak = _response['records'][2]['fields']['streak'];
                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                Text("Productivity streak score",
                                    style: GoogleFonts.inter(
                                        color: Colors.white,
                                        fontSize: 14,
                                        fontWeight: FontWeight.w600)),
                                IconButton(
                                  onPressed: () {
                                    // ignore: avoid_print
                                    Share.share(
                                        'Today was a streak productive day. Join Pause app here: https://pauseapp.harshitarora.in');
                                  },
                                  icon: const Icon(
                                    Icons.share,
                                    color: Colors.white,
